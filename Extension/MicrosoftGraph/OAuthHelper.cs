...
namespace MicrosoftGraph {
    ...
    public static class OAuthHelper {
        ...
        static Dictionary<string, object> buildAccessTokenDemandParameters(string code, string client_id, string clientRedirectUrl, string secret, string scope) {
        ...
        static internal JsonObject PostAccessToken(string oauthProviderAccessTokenUrl, string code, string client_id, string clientRedirectUrl, string secret, string scopes) {

            var parameters = buildAccessTokenDemandParameters(code, client_id, clientRedirectUrl, secret, scopes);
