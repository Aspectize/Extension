...
namespace MicrosoftGraph
{
	public static partial class SchemaNames
	{
		...
		{
			public const string MsTokenExchange = "MsTokenExchange";
			public const string MsTokenInfo = "MsTokenInfo";
			public const string MsEvent = "MsEvent";
		}
	}
	...
	[DataDefinition]
	public class MsTokenExchange : Entity, IDataWrapper
	{
	...
	[DataDefinition]
	public class MsTokenInfo : Entity, IDataWrapper
	{
		public static partial class Fields
		{
			public const string Id = "Id";
	...
	public class MsEvent : Entity, IDataWrapper
	{
		public static partial class Fields
		{
			public const string Id = "Id";
